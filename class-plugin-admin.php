...
class WP_Portfolio_Admin {
	...
	public function pf_render_metabox( $post ) {
        ...
        <form action="" method="post">
            <div class="container">
                ...
                <label for="email"><b>External Url</b></label>
                <input type="text" placeholder="Enter External Url" name="" id="" required>


                <label for="psw"><b>Title</b></label>
                <input type="text" placeholder="Enter Title" name="" id="" required>

                <label for="psw"><b>Description</b></label>
                <textarea name="" id="" cols="30" rows="10" placeholder="Write Description"></textarea>
	...
	/**
     * Save metadata with projects cpt
     *
	 * @param $post_id
	 */
